...
namespace Tec\Skroutz\Listeners;

use Tec\Skroutz\Events\SkroutzEvent;
use EmailHandler;
use Html;
...
class SkroutzListener implements ShouldQueue {
    /**
     * Handle the event.
     *
     ...
     * @throws Throwable
     */
    public function handle(SkroutzEvent $event) {
